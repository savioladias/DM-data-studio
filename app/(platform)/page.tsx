    ...
    <div className="p-8">
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          {/* New project card */}
          <Link href="/projects/new">
            <div className="border border-dashed border-border rounded-xl h-full min-h-[160px] flex flex-col items-center justify-center gap-2 text-muted-foreground hover:border-primary/50 hover:text-primary transition-colors cursor-pointer p-6">
